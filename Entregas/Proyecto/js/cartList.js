...
function comprarCarrito(){
    ...
    if (aPagar===0){
        Swal.fire({
            title: 'No tiene productos para pagar.',
            text: 'Elija sus productos favoritos',
            timer: 3000,
          ...
          setTimeout(function(){ window.location.assign('./carrito.html'); }, 3200);
    /* Swal.fire("No tiene productos para pagar.\n Pulse Ok \n o aguarde para redireccionar a espacio de compras"); */
    
    ;
} else {popupSwalPago(aPagar);} 
    /* return aPagar; */
}
 ...
 */
    function popupSwalPago(valor){
        Swal.fire({
        title: `Debe abonar: ${valor} $`,
        width: 600,
        padding: "3em",
        color: "#716add",
        imageUrl: "../../img/bolsa.gif",
        imageWidth: 200,
        imageHeight: 200,
        });
    }
